...
<section class="hero-bg relative overflow-hidden text-neutral">
    <div class="max-w-[1440px] mx-auto px-4 lg:px-10 xl:px-40 relative z-10 flex flex-col items-center min-h-[760px] pt-[110px] pb-[120px] text-center">
        ...
        <p class="mt-3 text-base lg:text-lg font-semibold text-primary dark:text-blue-400">
            PahamFin (Paham Finansial) — Your Automatic Financial Assistant
        </p>
        <p class="mt-4 text-base lg:text-lg leading-[170%] max-w-[760px] text-gray-600 dark:text-slate-300">
